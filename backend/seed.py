...
def seed():
    ...
    try:
        ...
        if not pack1:
            ...
            # スタンダードパックのカード一覧（A賞〜E賞）
            standard_cards = [
                # A賞 (1%)
                Card(pack_id=pack1.id, name="神龍カイザー", rarity="A賞", probability=0.01,
                ...
                # B賞 (4%)
                Card(pack_id=pack1.id, name="聖剣士アーサー", rarity="B賞", probability=0.02,
        ...
        if not pack2:
            ...
            premium_cards = [
                # A賞 (1%)
                Card(pack_id=pack2.id, name="究極神フェニックス", rarity="A賞", probability=0.01,
                ...
                # B賞 (4%)
                Card(pack_id=pack2.id, name="天空竜セラフィム", rarity="B賞", probability=0.02,
                ...
                Card(pack_id=pack2.id, name="深淵の魔王バアル", rarity="B賞", probability=0.02,
                ...
                # C賞 (15%)
                Card(pack_id=pack2.id, name="聖女ヴァルキリー", rarity="C賞", probability=0.05,
                ...
                Card(pack_id=pack2.id, name="鋼鉄巨人ゴーレム", rarity="C賞", probability=0.05,
                ...
                Card(pack_id=pack2.id, name="時空魔道士クロノス", rarity="C賞", probability=0.05,
                ...
                # D賞 (30%)
                Card(pack_id=pack2.id, name="金の騎士オーレス", rarity="D賞", probability=0.10,
                ...
                Card(pack_id=pack2.id, name="毒の暗殺者シャドウ", rarity="D賞", probability=0.10,
                ...
                Card(pack_id=pack2.id, name="賢者オラクル", rarity="D賞", probability=0.10,
                ...
                # E賞 (50%)
                Card(pack_id=pack2.id, name="鉄壁の盾兵シールド", rarity="E賞", probability=0.125,
                ...
                Card(pack_id=pack2.id, name="小さな妖精ピクシー", rarity="E賞", probability=0.125,
                ...
                Card(pack_id=pack2.id, name="山の石巨人ロック", rarity="E賞", probability=0.125,
                ...
                Card(pack_id=pack2.id, name="海の人魚マーメイド", rarity="E賞", probability=0.125,
        ...
        if not pack3:
            ...
            limited_cards = [
                # A賞 (1%)
                Card(pack_id=pack3.id, name="創世神オーディン", rarity="A賞", probability=0.01,
                ...
                Card(pack_id=pack3.id, name="狼神フェンリル", rarity="C賞", probability=0.05,
                ...
                Card(pack_id=pack3.id, name="知恵神ミーミル", rarity="C賞", probability=0.05,
                ...
                # D賞 (30%)
                Card(pack_id=pack3.id, name="戦乙女ブリュンヒルデ", rarity="D賞", probability=0.10,
                ...
                Card(pack_id=pack3.id, name="火の神ロキ", rarity="D賞", probability=0.10,
                     description="変幻自在の炎神。",
                     image_url=f"{PLACEHOLDER_BASE}/38bdf8/001a2a?text=%E7%81%AB%E7%A5%9E%E3%83%AD%E3%82%AD"),
                Card(pack_id=pack3.id, name="氷の女王スカジ", rarity="D賞", probability=0.10,
                ...
                # E賞 (50%)
                Card(pack_id=pack3.id, name="エインフェリア戦士", rarity="E賞", probability=0.125,
                ...
                Card(pack_id=pack3.id, name="ドワーフ職人", rarity="E賞", probability=0.125,
                ...
                Card(pack_id=pack3.id, name="エルフの弓手", rarity="E賞", probability=0.125,
                     description="長命のエルフ族の弓手。",
                     image_url=f"{PLACEHOLDER_BASE}/94a3b8/0a1020?text=%E3%82%A8%E3%83%AB%E3%83%95%E5%BC%93%E6%89%8B"),
                Card(pack_id=pack3.id, name="ヒューム冒険者", rarity="E賞", probability=0.125,
